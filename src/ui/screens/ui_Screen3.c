...
void ui_Screen3_screen_init(void)
{
    ...
    lv_img_set_src(ui_Image7, &ui_img_chatgpt_image1_png);
    ...
    lv_img_set_angle(ui_Image7, 1800);
    ...
    lv_obj_set_style_text_font(ui_Label5, &ui_font_large, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Image2 = lv_img_create(ui_Screen3);
    lv_img_set_src(ui_Image2, &ui_img_clockwise_sec_png);
    lv_obj_set_width(ui_Image2, LV_SIZE_CONTENT);   /// 31
    lv_obj_set_height(ui_Image2, LV_SIZE_CONTENT);    /// 180
